...
def hackrx_run():
    ...
    try:
        ...
        required_fields = ['claim_id', 'query', 'pdf_path']
        ...
        response = {
            ...
            "policy_id": policy_id,
            "pdf_source": "uploaded" if pdf_path != "/Users/manav/Documents/SmartClaimsAI/sample docs/BAJHLIP23020V012223.pdf" else "default"
        }
...
if __name__ == '__main__':
    ...
    default_pdf = "/Users/manav/Documents/SmartClaimsAI/sample docs/BAJHLIP23020V012223.pdf"
    try:
        initialize_vector_store(default_pdf, "BAJHLIP23020V012223")
        logger.info("Default policy loaded successfully")
    except Exception as e:
